                    ...
                    <SwiperSlide>
                        <div className="col-12 col-lg-6 mt-3 ps-1 text-center">
                            <div className='row '>
                                ...
                                <div className='col-12 justify-content-center d-flex'>
                                    <h3 className='modal-info-1 mt-2 mb-4'>{selectedItem.name}</h3>
                                </div>
                                {selectedList}
                            </div>
                            <div className="mt-3">
                                <h4 className='modal-info-6 mb-0' style={{textDecoration:"line-through"}}>{selectedItem.old_price} {selectedItem.currency}{/* {selectedItem.month && (<span className='month'>/aylık</span>)} */}</h4>
