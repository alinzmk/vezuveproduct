        ...
        <div className="sidebar-wrapper2">
          <div className="col-12 mt-0 ms-2 ps-2 text-center">
            ...
            <ul className="sidebar-ul2">
              <li
                className={
                  (splitLocation[1] === "admin" &&
                    splitLocation[2] === "MusteriSec") ||
                  !splitLocation[1]
                    ? "side-active sidebar-li2"
                    : "sidebar-li2"
                }
              >
              ...
              <li
                className={
                  splitLocation[1] === "admin" && splitLocation[2] === "Profil"
                    ? "side-active sidebar-li2"
                    : "sidebar-li2"
                }
              >
              ...
              <li
                className={
                  splitLocation[1] === "admin" && splitLocation[2] === "Urunler"
                    ? "side-active sidebar-li2"
                    : "sidebar-li2"
                }
              >
              ...
              <li
                className={
                  splitLocation[1] === "admin" && splitLocation[2] === "Proje"
                    ? "side-active sidebar-li2"
                    : "sidebar-li2"
                }
              >
              ...
              <li
                className={
                  splitLocation[1] === "admin" &&
                  splitLocation[2] === "duyurular"
                    ? "side-active sidebar-li2"
                    : "sidebar-li2"
                }
              >
                <NavLink to={"/admin/duyurular"} className="sidebar-link" activeClassName="side-active"
                >
