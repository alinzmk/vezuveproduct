              ...
              <div className="col-11 pbg pt-3">
                <nav>
                  <div class="nav nav-tabs" id="service-tab" role="tablist">
                    ...
                    <button
                      class="nav-link  services-active"
                      id="nav-home-tab"
                      data-bs-toggle="tab"
                ...
                <div class="tab-content" id="nav-tabContent">
                          ...
                          <>
                            <nav>
                              ...
                              >
                                ...
                                <button
                                  className={`nav-link ${
                                    activeTab === "handmade" ? "active" : ""
                                  }`}
                                  id="amazonHandmade-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#amazonHandmade"
                                  type="button"
                                  role="tab"
                                  aria-controls="amazonHandmade"
                                  aria-selected={
                                    activeTab === "handmade" ? "true" : "false"
                                  }
                                >
                                  Amazon Handmade
                                </button>
                                ...
                                <button
                                  className={`nav-link ${
                                    activeTab === "allegro" ? "active" : ""
                                  }`}
                                  id="allegro-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#allegro"
                                  type="button"
                                  role="tab"
                                  aria-controls="allegro"
                                  aria-selected="false"
                                >
                                  Allegro
                                </button>
                                <button
                                  className={`nav-link ${
                                    activeTab === "trendyol" ? "active" : ""
                                  }`}
                                  id="trendyol-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#trendyol"
                                  type="button"
                                  role="tab"
                                  aria-controls="trendyol"
                                  aria-selected="false"
                                >
                                  Trendyol
                                </button>
                                <button
                                  className={`nav-link ${
                                    activeTab === "walmart" ? "active" : ""
                                  }`}
                                  id="walmart-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#walmart"
                                  type="button"
                                  role="tab"
                                  aria-controls="walmart"
                                  aria-selected="false"
                                >
                                  Walmart
                                </button>
                                <button
                                  className={`nav-link ${
                                    activeTab === "wayfair" ? "active" : ""
                                  }`}
                                  id="wayfair-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#wayfair"
                                  type="button"
                                  role="tab"
                                  aria-controls="wayfair"
                                  aria-selected="false"
                                >
                                  Wayfair
                                </button>
                                ...
                                <button
                                  className={`nav-link ${
                                    activeTab === "fruugo" ? "active" : ""
                                  }`}
                                  id="fruugo-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#fruugo"
                                  type="button"
                                  role="tab"
                                  aria-controls="fruugo"
                                  aria-selected="false"
                                >
                                  Fruugo
                                </button>
                                <button
                                  className={`nav-link ${
                                    activeTab === "vezuve" ? "active" : ""
                                  }`}
                                  id="vezuve-tab"
                                  data-bs-toggle="tab"
                                  data-bs-target="#vezuve"
                                  type="button"
                                  role="tab"
                                  aria-controls="vezuve"
                                  aria-selected="false"
                                >
                                  Web Altyapı
                                </button>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "handmade" ? "show active" : ""
                                }`}
                                id="amazonHandmade"
                                role="tabpanel"
                                aria-labelledby="amazonHandmade-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "etsy" ? "show active" : ""
                                }`}
                                id="etsy"
                                role="tabpanel"
                                aria-labelledby="etsy-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "allegro" ? "show active" : ""
                                }`}
                                id="allegro"
                                role="tabpanel"
                                aria-labelledby="allegro-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "trendyol" ? "show active" : ""
                                }`}
                                id="trendyol"
                                role="tabpanel"
                                aria-labelledby="trendyol-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "walmart" ? "show active" : ""
                                }`}
                                id="walmart"
                                role="tabpanel"
                                aria-labelledby="walmart-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "wayfair" ? "show active" : ""
                                }`}
                                id="wayfair"
                                role="tabpanel"
                                aria-labelledby="wayfair-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "emag" ? "show active" : ""
                                }`}
                                id="emag"
                                role="tabpanel"
                                aria-labelledby="emag-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "ozon" ? "show active" : ""
                                }`}
                                id="ozon"
                                role="tabpanel"
                                aria-labelledby="ozon-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "fruugo" ? "show active" : ""
                                }`}
                                id="fruugo"
                                role="tabpanel"
                                aria-labelledby="fruugo-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                              ...
                              <div
                                className={`tab-pane fade ${
                                  activeTab === "vezuve" ? "show active" : ""
                                }`}
                                id="vezuve"
                                role="tabpanel"
                                aria-labelledby="vezuve-tab"
                              >
                                <div className="row mt-4">
                                  {filterPackagesByFirstWord(
                                    servicepkgs,
                  ...
                  >
                    <div className="hizmet-wrap-vezu">
                      <p>
                        Hizmet Açıklamalarını Okumak İçin Hizmetin Üstüne
                        Tıklayınız.
                      </p>
                        ...
                        {partner &&
                          ...
                          partner.data.partners.map((ppartner, index) => (
                            <div className="col-12 col-lg-4 mb-4" key={index}>
                              <div className="">
                                <div
                                  className="accordion accordion-flush hizmet vezu"
